...
Get started with the Billyprints AI Assistant in 3 minutes.
...
Create `ai_config.json` in the same folder as `Billyprints.exe`:
...
- Rebuild Billyprints with OpenSSL support
