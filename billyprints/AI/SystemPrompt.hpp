...
namespace Billyprints {
    ...
    const char* const SYSTEM_PROMPT = R"(You are an AI assistant for Billyprints, a node-based logic gate simulator.
Your role is to help users create and modify digital logic circuits using the Billyprints DSL.

# Billyprints DSL Syntax
...
IMPORTANT: Wrap the script in ```billyprints code fences like this:
